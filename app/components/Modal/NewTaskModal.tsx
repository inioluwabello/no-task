...
export const NewTaskModal = ({ statusOptions, boardId }: { statusOptions: string[], boardId: string }) => {
    ...
    const createTaskHandler = () => {
        dispatch(createNewTaskAsync({ task, boardId: boardId }));
        ...
        <div className="overlay flex">
            <div className="modal">
                <div className="space-between">
                    ...
                    <img className="pointer close-btn" width={16} height={16} onClick={() => dispatch(modalSlice.actions.setState(false))} src="/images/icon-cross.svg" alt="" />
                </div>
                <div className="modal-body">
                        ...
                        return <div key={index}>
                            <div className="flex v-align">
                                ...
                                <img className="pointer close-btn" 
                                    ...
                                    width={12} height={12} onClick={() => removeSubTask(index)} src="/images/icon-cross.svg" alt="" />
                            </div>
                        </div>
                    })}
                    ...
                    <select name="status" id="status"
                        ...
                        {statusOptions.map((statusOption, i) => {
                            return <option key={i} value={statusOption}>{statusOption}</option>
                        })}
                    </select>
